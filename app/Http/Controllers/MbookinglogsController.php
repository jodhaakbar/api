...
class MbookinglogsController extends Controller {
	...
	public $module = 'mbookinglogs';
	static $per_page	= '20';

	public function __construct()
	{
		parent::__construct();
		$this->model = new Mbookinglogs();

		$this->info = $this->model->makeInfo( $this->module);
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'mbookinglogs',
 ...
 */
	public static function display(  )
	{
		...
		$model  = new Mbookinglogs();
		$info = $model::makeInfo('mbookinglogs');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('mbookinglogs.public.view',$data);
			}
		}
		else {
			...
			return view('mbookinglogs.public.index',$data);
		}
