...
use App\Models\Mtrxbooking;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class MtrxbookingController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'mtrxbooking';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Mtrxbooking();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'mtrxbooking',
	...
	public static function display(  )
	{
		...
		$model  = new Mtrxbooking();
		$info = $model::makeInfo('mtrxbooking');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('mtrxbooking.public.view',$data);			
			}			
		} 
		else {
			...
			return view('mtrxbooking.public.index',$data);	
		}
