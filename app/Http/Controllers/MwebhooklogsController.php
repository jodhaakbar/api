...
use App\Models\Mwebhooklogs;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class MwebhooklogsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'mwebhooklogs';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Mwebhooklogs();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'mwebhooklogs',
	...
	public static function display(  )
	{
		...
		$model  = new Mwebhooklogs();
		$info = $model::makeInfo('mwebhooklogs');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('mwebhooklogs.public.view',$data);			
			}			
		} 
		else {
			...
			return view('mwebhooklogs.public.index',$data);	
		}
