...
//Default Controller
Route::post('/webhook', 'UserController@postGojekWebHookHandle');
...
/* Auth & Profile */
Route::get('/sso','UserController@getSso');
Route::get('/sso_out','UserController@getLogout');

//Route::get('/pointhistory','HomeController@pointhistory');


Route::get('/nkl/sso','UserController@getSso');
Route::get('/nkl/sso_out','UserController@getLogout');
...
Route::post('vote','HomeController@postVote');
Route::post('kartu','HomeController@postKartu');
...
Route::resource('api','SximoapiController');
