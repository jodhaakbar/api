...
<?php $__currentLoopData = $tableForm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	<?php if($t['search'] =='1'): ?>
		<tr id="<?php echo e($t['field']); ?>" class="fieldsearch">
			<td><?php echo SiteHelpers::activeLang($t['label'],(isset($t['language'])? $t['language'] : array())); ?> </td>
			<td > 
			<select id="<?php echo e($t['field']); ?>_operate" class="form-control input-sm oper" name="operate" onchange="changeOperate(this.value , '<?php echo e($t['field']); ?>')">
...
jQuery(function(){
	...
	$('.doSearch').click(function(){
		...
		<?php if($searchMode =='ajax') { ?> 
			reloadData( '#<?php echo e($pageModule); ?>',"<?php echo e($pageUrl); ?>/data?search="+attr);	
			$('#sximo-modal').modal('hide');
		<?php } else { ?>
			window.location.href = '<?php echo e($pageUrl); ?>?search='+attr;
		<?php } ?>
	});
});
