...
<?php echo $__env->make('sximo.config.tab', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
	 <?php echo Form::open(array('url'=>'sximo/config/save/', 'class'=>'form-horizontal row validated', 'files' => true)); ?>
	  ...
	  <div class="form-group">
	   ...
	   <div class="form-group">
		...
		<div class="col-md-8">
				...
				<?php $__currentLoopData = SiteHelpers::langOption(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<?php if(config('sximo.cnf_lang') ==$lang['folder']): ?> selected <?php endif; ?>
	   ...
	   <div class="form-group">
		...
		<div class="col-md-8">
				...
				<?php $__currentLoopData = SiteHelpers::themeOption(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	   ...
	   <div class="form-group" style="display: none;">
		...
		<div class="col-md-8">
				...
				<?php $__currentLoopData = SiteHelpers::backendOption(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<option value="<?php echo e($t['folder']); ?>"
					<?php if($sximoconfig['cnf_backend'] ==$t['folder']): ?> selected <?php endif; ?>
					><?php echo e($t['name']); ?></option>
				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			</select>
		 </div> 
	  ...
	  <div class="form-group">
		...
		<div class="col-md-8">
			...
			foreach($dates as $key=>$val) {?>
				...
				<?php if(config('sximo.cnf_date') ==$key): ?> selected <?php endif; ?>
	   ...
	   <div class="form-group">
		...
		<div class="col-md-8">
			...
			<div style="padding:5px; border:solid 1px #243646 ; background:#243646 ; width:auto;">
			 	<?php if(file_exists(public_path().'/uploads/images/'.$sximoconfig['cnf_logo']) && $sximoconfig['cnf_logo'] !=''): ?>
			 	<img src="<?php echo e(asset('uploads/images/'.$sximoconfig['cnf_logo'])); ?>" alt="<?php echo e($sximoconfig['cnf_appname']); ?>" />
			 	<?php else: ?>
				<img src="<?php echo e(asset('uploads/logo.png')); ?>" alt="<?php echo e($sximoconfig['cnf_appname']); ?>" />
				<?php endif; ?>	
			</div>				
		 </div> 
	  </div>  		  
