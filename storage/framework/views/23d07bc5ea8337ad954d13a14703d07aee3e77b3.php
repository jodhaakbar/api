 <?php echo Form::open(array('url'=>'sximo/module/dobuild/'.$module_name, 'class'=>'form-horizontal','id'=>'rebuildForm')); ?>
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <a href="<?php echo e(url('sximo/module/rebuild/'.$module_id)); ?>" class="btn btn-danger" id="rebuild" ><i class="fa fa-repeat"></i> Rebuild All Codes </a> 
      </div>
  </div> 
<hr />
    <p class="text-center " style="font-weight: bold;">
 ...
 <h5> Backend View </h5>
  ...
  <div class="form-group">
	...
	<div class="col-md-8">
	  ...
	  <code> <?php echo e(ucwords($module)); ?>Controller.php </code> <br />will be replaced with new code 
	  </label>
	 </div> 
  </div>  
  ...
  <div class="form-group">
	...
	<div class="col-md-8">
	  <label class="">
		 ...
		 <code><?php echo e(ucwords($module)); ?>.php</code> Model <br />will be replaced with new code 
	  </label>
	 </div> 
  </div>  
  ...
  <div class="form-group">
	...
	<div class="col-md-8">
	  ...
	  <code>index.blade.php</code>  at <code>views/<?php echo e($module); ?>/ </code> folder <br /> will be replaced with new code 
	  </label>
	 </div> 
  </div>  
  ...
  <div class="form-group">
	...
	<div class="col-md-8">
	  ...
	  <code>form.blade.php</code>  at <code>views/<?php echo e($module); ?>/ </code> folder <br /> will be replaced with new code 
  ...
  <div class="form-group">
	...
	<div class="col-md-8">
     ...
     <code>view.blade.php</code>  at <code>views/<?php echo e($module); ?>/ </code> folder <br /> will be replaced with new code 
	  </label>
	   <input name="rebuild" type="hidden" id="rebuild" value="ok">
	   <input name="module_id" type="hidden" id="module_id" value="<?php echo e($module_id); ?>">
	 </div> 
  </div>   
	<hr />
 <h5> Frontend  View <sup class="badge badge-success">New</sup></h5>
  ...
  <div class="form-group">
	...
	<div class="col-md-8">
     ...
     <code>index.blade.php</code>  at <code>views/<?php echo e($module); ?>/public/ </code> folder <br /> will be replaced with new code 
	  </label>
	...
	<div class="col-md-8">
     ...
     <code>view.blade.php</code>  at <code>views/<?php echo e($module); ?>/public/ </code> folder <br /> will be replaced with new code 
	  </label>
   ...
   <div class="form-group">
	...
	<div class="col-md-8">
     ...
     <code>form.blade.php</code>  at <code>views/<?php echo e($module); ?>/public </code> folder <br /> will be replaced with new code 
	  </label>
