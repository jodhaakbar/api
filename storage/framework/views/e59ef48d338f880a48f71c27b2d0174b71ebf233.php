		...
		<div class="sbox">
			...
			<div class="row">
				<div class="col-md-4"> 	
					...
					<a href="<?php echo e(url('muserss/create?return='.$return)); ?>" class="btn btn-default btn-sm"  
			...
			<div class="table-responsive" style="padding-bottom: 70px;">
 			<?php echo Form::open(array('url'=>'muserss?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'SximoTable' )); ?>
							...
							<td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
									...
									<li><a href="<?php echo e(url('muserss/'.$row->id.'?return='.$return)); ?>" class="tips" title="<?php echo e(__('core.btn_view')); ?>"> <?php echo e(__('core.btn_view')); ?> </a></li>
									<?php endif; ?>
									<?php if($access['is_edit'] ==1): ?>
									<li><a  href="<?php echo e(url('muserss/'.$row->id.'/edit?return='.$return)); ?>" class="tips" title="<?php echo e(__('core.btn_edit')); ?>"> <?php echo e(__('core.btn_edit')); ?> </a></li>
									<?php endif; ?>
